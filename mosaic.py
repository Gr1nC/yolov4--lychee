...
import cv2
# 读取原始图片和标注框
# img1 = cv2.imread("mosaic/matureperiod4.jpg")
# bbox1 = xml("mosaic/matureperiod4.xml")
# img2 = cv2.imread("mosaic/tree_202_xh6_20201005113900.jpg")
# bbox2 = xml("mosaic/tree_202_xh6_20201005113900.xml")
# img3 = cv2.imread("mosaic/tree_202_xh6_20210317083900.jpg")
# bbox3 = xml("mosaic/tree_202_xh6_20210317083900.xml")
# img4 = cv2.imread("mosaic/youngfruitperiod12.jpg")
# bbox4 = xml("mosaic/youngfruitperiod12.xml")
...
if __name__ == '__main__':
    ...
    # 给出图片文件夹和检测框文件夹所在的位置
    image_dir = 'mosaic/img'
    annotation_dir = 'mosaic/xml'
